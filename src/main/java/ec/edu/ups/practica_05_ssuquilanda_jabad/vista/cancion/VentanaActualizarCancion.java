...
public class VentanaActualizarCancion extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnAceptarActualizarCancion = new javax.swing.JButton();
        ...
        jLabel2.setText("Ingresar el codigo de la cancion actualizar :");
        ...
        btnAceptarActualizarCancion.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        btnAceptarActualizarCancion.setText("Actualizar");
        btnAceptarActualizarCancion.setEnabled(false);
        btnAceptarActualizarCancion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAceptarActualizarCancionActionPerformed(evt);
            }
        });
        jPanel4.add(btnAceptarActualizarCancion, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 290, 100, 30));

        lblicono1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/disco.png"))); // NOI18N
        jPanel4.add(lblicono1, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 0, 330, 340));
        ...
        jLabel3.setText("Ingrese el codigo del compositor, del cual se va a actualizar una cancion:");
        ...
        getContentPane().add(panelCantante1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 990, 314));
    ...
    private void btnAceptarActualizarCancionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActualizarCancionActionPerformed
        ...
        cancion.setTiempoEnMinutos(tiempoCan);
        if (controladorCompositor.actualizarCancion(compositorSeleccionado, cancion)) {
            JOptionPane.showMessageDialog(this, "La cancion ha sido actualizada exitosamente! :)");
            this.limpiarCamposCompositor();
            this.limpiarCamposCancion();
    ...
    private javax.swing.JButton btnAceptarActualizarCancion;
