...
public class VentanaBuscarCancion extends javax.swing.JInternalFrame {
    ...
    public void cambiarIdioma(Locale localizacion){
        ...
        jLabel3.setText(mensajes.getString("txtInstruccionBuscarCancion1"));
        ...
        jLabel2.setText(mensajes.getString(("txtInstruccionBuscarCancion2")));
        ...
        btnBuscarCancion.setText(mensajes.getString("txtAceptar"));
    ...
    private void initComponents() {
        ...
        jPanel4.add(btnCancelarBuscarCancion, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 290, 104, 32));

        jLabel2.setFont(new java.awt.Font("Hoefler Text", 1, 24)); // NOI18N
        jLabel2.setText("Ingresar el codigo de la cancion a buscar :");
        ...
        jPanel4.add(lblNombreCrearPersona7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 78, 30));
        ...
        btnBuscarCancion.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        ...
        jPanel4.add(btnBuscarCancion, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 290, 100, 30));

        lblicono1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/disco.png"))); // NOI18N
        jPanel4.add(lblicono1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 0, 330, 340));

        lblcantantaFondo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/background.jpeg"))); // NOI18N
        jPanel4.add(lblcantantaFondo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 0, 360, 340));
        ...
        jPanel4.add(lblCantante, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 370, 50));

        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 310, -1, 330));
        ...
        panelCantante1.add(lblFechaNacimientoCrearPersona1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 90, 30));
        ...
        panelCantante1.add(lblNombreCrearPersona4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 90, 30));

        lblNombreCrearPersona5.setFont(new java.awt.Font("AkayaKanadaka", 0, 24)); // NOI18N
        lblNombreCrearPersona5.setText("Codigo:");
        panelCantante1.add(lblNombreCrearPersona5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 78, 30));
        ...
        panelCantante1.add(lblNacionalidadBuscarCantante1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 140, 30));
        ...
        jLabel3.setText("Ingrese el codigo del compositor, del cual se va a buscar una cancion:");
    ...
    private void btnBuscarCancionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarCancionActionPerformed
        ...
        if (codigoCancion.isEmpty()) {
            ...
            Cancion cancion = controladorCompositor.buscarCancion(compositorSeleccionado,codiguito);
            if (cancion != null) {
